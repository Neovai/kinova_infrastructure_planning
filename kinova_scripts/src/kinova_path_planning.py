...
class MoveRobot():
    ...
    def main(self):
        ...
        if(self.planning == "1"):
            ...
            current_point = [0.594897268928, -0.00552424651151, 1.08080196315, -0.0552241400824, 0.998162456525, -0.0237767228365, -0.0075280931829]
            ...
            current_point[0] = current_point[0] + .105
            current_point[2] = current_point[2] - .081
            self.go_to_goal(current_point, "point3.yaml")
            
            rospy.loginfo("putting palm to handle [point 4 of 4]")
            current_point[0] = current_point[0] + .005
            current_point[2] = current_point[2] - .081
            ...
            current_point[0] = current_point[0] - 0.15 #distance to pull drawer (<=20cm)
            self.go_to_goal(current_point, "pull_drawer.yaml")
            ...
            rospy.loginfo("pulling drawer out")
            self.run_yaml("pull_drawer.yaml")
            rospy.loginfo("releasing handle")
